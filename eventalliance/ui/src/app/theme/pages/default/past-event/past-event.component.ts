...
export class PastEventComponent implements OnInit, AfterViewInit {
    ...
    showMore (totalEvent: number) {
        //alert(totalEvent);
        Helpers.setLoading(true);
        this.limit = totalEvent;
        this.More = 1;
        if(this.More == 1) {
    ...
    ngAfterViewInit() {
        this.activatedRoute.params.subscribe((params: Params) => {
            ...
            this._artistDetailService.getDetails(this.artistId).subscribe((t: any) => {
                ...
                this._artistDetailService.getPastEventFromBandsintown(this.artistName).subscribe((data: any) => {
