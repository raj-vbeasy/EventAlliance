...
export class ArtistDetails {
    ...
    getCurrentEventFromBandsintown( ArtistName: string ): Observable<any> {
        return this._httpClient.get<any>('https://rest.bandsintown.com/artists/' + ArtistName +'/events?app_id=bandsintown_web').map((response):any => {
            /*console.log('Service getCurrentEventFromBandsintown' + ArtistName);
    ...
    getPastEventFromBandsintown( ArtistName: string ): Observable<any> {
        return this._httpClient.get<any>('https://rest.bandsintown.com/artists/' + ArtistName +'/events?app_id=bandsintown_web&date=past').map((response):any => {
            return response;
        });
    }
