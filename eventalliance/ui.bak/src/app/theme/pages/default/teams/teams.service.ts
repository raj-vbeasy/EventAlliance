...
export class TeamService {  
    ...
    teamName: string;
    teamData: JSON;
    private userUrl: any = 'http://internalmail.com/saheb-php/fetchjsondata.php';
    private memberAssignUrl: any = 'http://internalmail.com/saheb-php/userjsondata.php'; //'https://jsonplaceholder.typicode.com/users'; // URL to web api
   ...
   /*insertTeamData() {
    ...
    getTeamUsers(): Observable<TeamMember[]>{
    	
        return this._http.get(this.memberAssignUrl)
            .map(res => <TeamMember[]>res.json());
    }
